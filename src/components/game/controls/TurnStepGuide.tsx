  ...
  return (
    <div className="bg-amber-50 p-3 rounded-lg border border-amber-200 w-full mt-2">
      ...
      <ol className="list-decimal text-sm text-amber-700 pl-5">
        ...
        <li className={currentStep > 2 ? "line-through opacity-60" : currentStep === 2 ? "font-bold" : ""}>Draw or use a card</li>
        <li className={currentStep === 3 ? "font-bold" : ""}>Move a meeple the exact number shown</li>
        <li>End turn</li>
      </ol>
    </div>
  );
